...
<div id="preview">
    <div id="preview-title">
        ...
        <Addition icon="pencil-outline" name="Author" description="Strawberry Shop"></Addition>
...
export default {
    ...
    setup(props, { emit }) {
        ...
        const copyLinkToClipboard = () => {
            navigator.clipboard
                .writeText('https://strawberryshop.github.io/?' + encodeURIComponent(JSON.stringify(file.value)))
                .then(() => {
